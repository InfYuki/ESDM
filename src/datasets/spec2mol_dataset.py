...
class Spec2MolDataModule(MolecularDataModule):
    def __init__(self, cfg):
        ...
        '''
        ###################
        spec_kwargs = dict(cfg.dataset)
        spec_kwargs.pop("spec_features", None)

        spec_featurizer = featurizers.get_spec_featurizer(
            cfg.dataset.spec_features,
            cache_dir=cfg.dataset.dreams_cache_dir,
            **spec_kwargs
        )
